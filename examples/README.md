...
_Salary & Negotiation · last run **2026-08-15 19:09 UTC** — regenerate with `npm run coach:scenarios -- --area=salary`._
...
| 03 | [A foreign employer insisting on local currency](03-paid-in-local-currency.md) | Negotiates the mechanism — review interval, pegging — rather than arguing about the currency itself. | fail — no two replies open the same way |
