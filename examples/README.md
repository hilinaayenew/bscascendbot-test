...
_Salary & Negotiation · last run **2026-08-15 18:08 UTC** — regenerate with `npm run coach:scenarios -- --area=salary`._

**2 of 5 scenarios passed all checks.**

| # | Scenario | Tests | Result |
|---|---|---|---|
| 01 | [A nurse moving into health tech, offered far too little](01-career-changer-lowballed.md) | Crosses stage A into B mid-conversation, and treats a half offer as a mismatch rather than a starting point. | fail — no two replies open the same way |
| 02 | [She resigned and they suddenly found the money](02-counter-offer.md) | Stage C throughout, and asks why the number only appeared once she was leaving. | fail — no two replies open the same way; no reply mostly restates the one before it |
...
| 04 | [Told to wait for the review cycle, for the second year running](04-fobbed-off-twice.md) | Stage C. Recognises a pattern rather than repeating last year's advice. | fail — no two replies open the same way |
