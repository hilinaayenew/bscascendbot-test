...
_Salary & Negotiation · last run **2026-08-15 19:33 UTC** — regenerate with `npm run coach:scenarios -- --area=salary`._

**3 of 5 scenarios passed all checks.**

| # | Scenario | Tests | Result |
|---|---|---|---|
| 01 | [A nurse moving into health tech, offered far too little](01-career-changer-lowballed.md) | Crosses stage A into B mid-conversation, and treats a half offer as a mismatch rather than a starting point. | fail — never asks her to disclose her own pay; no two replies open the same way; no reply mostly restates the one before it |
