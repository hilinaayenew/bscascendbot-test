...
_Mentorship · last run **2026-08-23 19:46 UTC** — regenerate with `npm run coach:scenarios -- --area=mentorship`._
...
| 02 | [Has a mentor already, but wants to know if she also needs a sponsor](02-mentor-vs-sponsor.md) | Draws on S4 and keeps the mentor/sponsor distinction clear (advice vs advocacy) rather than blurring the two together. | pass |
...
| 05 | [In the BSC mentorship programme but doesn't have a clear career goal yet](05-bsc-programme-no-clear-goal-yet.md) | Draws on S6 and reassures that being unsure is workable — tell the mentor directly — rather than treating the lack of a goal as a problem to fix before starting. | pass |
